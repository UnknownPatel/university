...
<div className="p-4 sm:ml-64">
   <div className="p-4 rounded-lg mt-14">
      ...
      <div className='text-center text-2xl mt-20'>
        <h1>Get Started By Uploading Exacl File</h1>
      </div>
      <div className='flex justify-center'>
        <input class="mt-5 text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none  dark:border-gray-600 dark:placeholder-gray-400" id="default_size" type="file"/>
      </div>
