      ...
      <div className="">
        <div className="p-4 rounded-lg mt-14">
          ...
          <input
            ...
            class="bg-gray-50 border-0 ml-2 border-b-2  text-gray-900 text-sm rounded-lg block w-auto pl-10 p-2.5 border-gray-600 "
...
export default StudentViewSyllabus
