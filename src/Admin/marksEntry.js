      ...
      <ul className="space-y-2 font-medium">
         {/* <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
               <span className="ml-3">Create Syllabus</span>
            </a>
         </li> */}
               {/* <svg aria-hidden="true" className="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path><path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path></svg> */}
         {/* <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
               <span className="flex-1 ml-3 whitespace-nowrap">View Syllabus</span>
            </a>
         </li> */}
         ...
         <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
               ...
               <span className="flex-1 ml-3 whitespace-nowrap">Marks Entry Permission</span>
...
<div className="p-4 sm:ml-64">
   ...
   <div className='text-center text-4xl'>
        <p>Marks Entry Permission</p>
    </div>
       
       <div className='flex justify-between mt-10'>
       <label htmlFor="hs-select-label" className="block text-sm font-bold mb-2">Select Faculty:</label>
        <select className="py-3 px-4 pr-9 block w-56 rounded-2xl text-sm border-2 ">
          ...
          <option></option>
              ...
              <label htmlFor="" className="block text-sm font-bold mb-2">Enter Subject Code:</label>
              <div className="">
                <input
                  type="text"
                  name=""
        ...
        <label htmlFor="hs-select-label" className="block text-sm font-bold mb-2">Select Subject Name:</label>
        <select className="py-3 px-4 pr-9 block w-56 rounded-2xl text-sm border-2 ">
          <option></option>
          <option></option>
          <option></option>
