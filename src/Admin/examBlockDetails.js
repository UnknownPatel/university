...
const ExamBlockDetails = () => {
          ...
          if (res.data.status === "ok") {
            ...
            if (res.data.data.time_tables.length !== 0) {
              ...
              res.data.data.time_tables.map((time_table) => {
                axios
                  .get(
                    `/time_table_block_wise_reports/${time_table.id}/fetch_details`,
                    {
                      headers,
                      params: {
                        subdomain: subdomain,
  ...
  const handleSubmitBlockWiseReport = (e, time_table_id, no_of_students) => {
    ...
    if (e.target.innerHTML === "Update") {
      ...
      axios
        .put(
          `/time_table_block_wise_reports/${report_id}`,
          {
            subdomain: subdomain,
          ...
          <div>
            ...
            <div className="p-4 sm:ml-64">
              ...
              <div
                ...
                className="hidden flex-col h-[75vh] max-h-fit overflow-y-scroll mt-5"
              >
                <div className="">
