...
<div className="p-4 sm:ml-64">
   ...
   <div className='text-center text-4xl'>
       ...
       <label htmlFor="hs-select-label" className="block text-sm font-bold mb-2">Select Cource:</label>
        ...
        <label htmlFor="hs-select-label" className="block text-sm font-bold mb-2">Select Subject:</label>
        <select className="py-3 px-4 pr-9 block w-56 rounded-2xl text-sm border-2 ">
          <option></option>
          <option></option>
          <option></option>
