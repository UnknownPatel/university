...
const JrSupervisionModal = ({ setOpenModal, id }) => {
  useEffect(() => {
  ...
  const handleDeleteSupervision = (e) => {
      ...
      axios
        ...
        .then((res) => {
          if (res.data.status === "ok") {
            setOpenModal(false);
            const submitButton = document.getElementById("jr-submit-button");
            submitButton.click();
          ...
          <div className="relative w-full max-w-lg p-4 mx-auto bg-white rounded-md shadow-lg">
            <div className="mt-3 flex flex-col sm:flex">
              ...
              <p className="mt-2 text-[15px] leading-relaxed text-gray-500">
                Are you sure you want to delete this supervision?
              </p>
...
export default JrSupervisionModal;
