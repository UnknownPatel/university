      ...
      <ul className="space-y-2 font-medium">
         ...
         <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
               ...
               <span className="flex-1 ml-3 whitespace-nowrap">Faculty Supervision List</span>
            </a>
         </li>
         <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
               {/* <svg aria-hidden="true" className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg> */}
               <span className="flex-1 ml-3 whitespace-nowrap">View Supervision List</span>
...
<div className="p-4 sm:ml-64">
   <div className="p-4 rounded-lg mt-14">
       ...
       <div className='text-center text-4xl'>
        <p>Create Exam TimeTable</p>
       </div>
       {/*  */}
       <div>
       <div className='flex justify-between mt-10'>
        <label htmlFor="" className="block text-sm font-bold mb-2">Cource:</label>
              <div className="">
                <input
                  type="text"
                  name=""
              ...
              <label htmlFor="" className="block text-sm font-bold mb-2">Semester:</label>
              <div className="">
                <input
                  type="text"
                  name=""
       ...
       <div className="flex flex-col">
        ...
        <div class="text-center mt-10">
            <button class="py-3 px-8 bg-gray-800 rounded-2xl text-white font-bold">Download</button> 
        </div>

        <div class="text-center mt-5">
            <button class="py-3 px-8 bg-gray-800 rounded-2xl text-white">Share</button> 
        </div>
