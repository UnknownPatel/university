            ...
            <div className="flex w-full">
              ...
              >
                ...
                <div
                  ...
                  className={`${
                    nameHidden ? "hidden" : "flex"
                  } flex-col overflow-y-scroll min-h-max h-4/5 mt-5 `}
                >
                  <div className="">
              ...
              >
                ...
                <div
                  ...
                  className={`${typeHidden ? "hidden" : "flex"} flex-col overflow-y-scroll min-h-max h-4/5 mt-5`}
                >
                  <div className="">
                    <div className="p-1.5 w-full inline-block align-middle">
                      <div className="border rounded-lg">
              ...
              >
                ...
                <div
                  ...
                  className={`${timeHidden ? "hidden" : "flex"} flex-col overflow-y-scroll min-h-max h-4/5 mt-5`}
                >
                  <div className="">
                    <div className="p-1.5 w-full inline-block align-middle">
                      <div className="border rounded-lg">
