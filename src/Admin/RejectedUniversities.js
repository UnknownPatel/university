                                ...
                                return (
                                  <tr key={university.id}>
                                    ...
                                    <td className="text-center px-6 py-4 text-sm text-gray-800 whitespace-nowrap">
                                      <button
                                        id={university.id}
                                        className="text-center w-auto bg-transparent text-green-600 p-3 rounded-full tracking-wide
                                  font-semibold  focus:outline-none focus:shadow-outline hover:bg-green-600 hover:text-gray-100 shadow-lg cursor-pointer transition ease-in duration-300"
                                        onClick={() => {
                                          setAcceptModal(true);
                                        }}
                                      >
                                        <div className="flex">
                                          <BiHappy size={20} className="mr-2" />{" "}
                                          Approve
                                        </div>
                                      </button>
...
export default RejectedUniversities;
