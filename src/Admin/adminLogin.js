...
<div className="bg-indigo-600 hidden lg:block w-full md:w-1/2 xl:w-2/3 h-screen">
  ...
  <img src="https://img.freepik.com/free-vector/privacy-policy-concept-illustration_114360-7853.jpg?size=626&ext=jpg&ga=GA1.1.273664279.1682681851&semt=sph" alt="" className="w-full h-full object-cover"/>
...
<div className="bg-white w-full md:max-w-md lg:max-w-full mx-auto md:mx-0 md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12
  ...
  <div className="w-full h-100">
    ...
    <h1 className="text-xl md:text-2xl font-bold leading-tight mt-12">Admin Login</h1>
