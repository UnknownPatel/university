    ...
    <div>
      <div>
        <nav
          ...
          } fixed top-0 z-50 w-full bg-white dark:bg-gray-800 dark:border-gray-700`}
        >
        ...
        <div
          className={`${
            loading ? "animate-pulse" : ""
          } fixed top-14 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700`}
        ></div>

        <div className={`${loading ? "animate-pulse" : ""} p-4 sm:ml-64`}>
          <div className="p-4 rounded-lg mt-14">
            <div className="justify-center text-4xl">
              {loading ? (
                <div className="h-14 bg-gray-200 rounded-full dark:bg-gray-700 w-96"></div>
              ) : (
                <p> Page Not Found </p>
              )}
            </div>
